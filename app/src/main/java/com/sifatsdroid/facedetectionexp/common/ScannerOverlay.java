package com.sifatsdroid.facedetectionexp.common;


/**
 * Created by Sifat Ullah Chowdhury on 9/15/2019.
 * Durbin Labs Ltd
...
import com.sifatsdroid.facedetectionexp.R;
...
public class ScannerOverlay extends ViewGroup {
    ...
    public ScannerOverlay(Context context, AttributeSet attrs, int defStyle) {
        ...
        lineColor = a.getColor(R.styleable.ScannerOverlay_line_color, ContextCompat.getColor(context, R.color.colorAccent));
